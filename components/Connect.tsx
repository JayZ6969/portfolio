...
const classes = {
  ...
  pupil: 'relative min-[1921px]:w-[6.663vw] min-[1921px]:h-[6.663vw] xl:w-[8rem] xl:h-[8rem] lg:w-[6.75rem] lg:h-[6.75rem] md:w-[5.5rem] md:h-[5.5rem] sm:w-[4.5rem] sm:h-[4.5rem] min-[430px]:w-[3.5rem] min-[430px]:h-[3.5rem] w-[3.25rem] h-[3.25rem] bg-black rounded-full',

...
const classes = {
  ...
  button: 'bg-white hover:bg-[#cee968] lg:w-[50px] lg:h-[50px] md:w-[50px] md:h-[50px] sm:w-[40px] sm:h-[40px] h-[35px] w-[35px] rounded-full mt-[-12px] ml-[-40px] lg:mr-[-15px] md:mr-[-15px] sm:mr-[18px] mr-[20px] cursor-pointer flex justify-center items-center',
  ...
  inside: 'font-pp-mori-semibold w-full h-[30px] text-[9px] lg:h-[50px] md:h-[50px] md:text-[18px] sm:h-[35px] sm:text-[13px] rounded-[10px] bg-[#141414] border-solid border-[1px] border-zinc-800 text-white text-[16px] px-[15px] lg:mt-[10px] md:mt-[10px] sm:mt-[10px] mt-[5px] hover:border-[#141414]',
  ...
  img1: 'md:w-[25px] md:h-[25px] w-[20px] h-[20px]',
  para: 'font-pp-mori-semibold text-white text-left mt-[40px] px-[20px] text-[17px]',
  container: 'flex flex-col lg:w-[570px] md:w-[670px] sm:w-[410px] w-[350px] h-auto items-center bg-black rounded-[30px] border-solid border-[1px] border-zinc-800',
  container1: 'flex flex-row justify-end lg:w-[500px] md:w-[600px] w-[350px] sm:w-[410px]',
  container2: 'flex sm:flex-row flex-col lg:w-[500px] md:w-[600px] sm:w-[410px] w-[310px] sm:my-[20px] my-[15px] lg:justify-between sm:justify-around justify-between',
  container3: 'flex lg:w-[500px] md:w-[600px] sm:w-[410px] lg:mt-[40px] md:mt-[40px] sm:mt-[40px] mt-[20px] justify-center',
  container4: 'flex flex-col gap-1',

...
const classes = {
  Container: 'flex items-center justify-center w-full bg-zinc-100 z-10',
  ...
  FeaturedHeader: 'border-b-2 border-black py-6 w-full font-inter font-bold tracking-tight text-black min-[1921px]:text-[4.373vw] min-[1440px]:text-[4.25rem] xl:text-[4rem] lg:text-[3.5rem] md:text-[3rem] min-[425px]:text-[2.5rem] text-[2rem] leading-none',
  ...
  ImageContainer: 'relative w-full xl:h-[60vh] lg:h-[50vh] sm:h-[40vh] h-[30vh] rounded-xl',
  ...
  CardImageHeader: 'absolute md:block hidden w-screen text-[#DFFF00] font-inter text-center font-bold leading-none tracking-tight xl:text-8xl md:text-6xl sm:text-4xl text-3xl z-20 top-1/2 -translate-y-1/2 rounded-md',
}
